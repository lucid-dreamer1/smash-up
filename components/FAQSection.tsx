...
export default function FAQSection() {
  ...
  return (
    <section id="faq" className="py-24 bg-white border-t border-[#F0D5DA]">
      <script
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="divide-y divide-[#F0D5DA] border-y border-[#F0D5DA]">
          {faqs.map((faq, index) => {
            ...
            return (
              <div key={index} className="py-5">
                ...
                >
                  <span className="font-[family-name:var(--font-display)] text-lg sm:text-xl font-bold text-[#2B0A12] group-hover:text-[#8A0427] transition-colors">
                    {faq.question}
                  </span>
                  <span
                    className={`text-[#8A0427] text-xl font-bold w-6 h-6 flex items-center justify-center transition-transform duration-300 ${
                ...
                >
                  <div className="overflow-hidden">
                    <p className="text-[#735058] text-sm font-light leading-relaxed pr-6">
                      {faq.answer}
                    </p>
                  </div>
                </div>
