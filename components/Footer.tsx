...
export default function Footer() {
  return (
    <footer id="contatti" className="bg-zinc-950 border-t border-zinc-800 text-zinc-400 text-xs">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          <div className="space-y-3">
            ...
            <p className="text-zinc-400 leading-relaxed font-light">
              ...
              <br />
              <span className="text-yellow-400 font-bold">Real Smash. Real Crust. No Bullsh*t.</span>
            </p>
            <a
          ...
          <div className="space-y-2">
            <h4 className="text-yellow-400 uppercase tracking-widest text-xs font-bold mb-3">
              Servizio &amp; Orari
            </h4>
          ...
          <div>
            ...
            <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-5 space-y-2">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-block bg-yellow-400 hover:bg-yellow-300 text-black text-[11px] font-black uppercase tracking-wider px-4 py-2 rounded-lg transition-colors mt-2"
              >
                Segui su Instagram →
              </a>
            </div>
